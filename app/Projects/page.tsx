    ...
    return (
        <>
            ...
            <div className='w-full  min-h-screen bg-neutral-950'>
                <div className='w-full max-w-3xl h-min-screen mx-auto bg-neutral-950 px-4 sm:px-6'>
                    <  Navbar />
                    <div className='pt-10 pb-10'>
                        ...
                        <div className='flex  justify-evenly gap-5 flex-col sm:flex-col md:flex-row'>
