        ...
        <div id="contact" className=" pt-10">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mt-5 px-1 sm:px-0">
              ...
              <div className="mt-4 sm:ml-7">
                <div className="bg-neutral-700/20 w-full lg:w-75 h-15 rounded-sm border border-white/20 hover:opacity-80">
                  <div className="flex justify-between px-3">
                    <a className="flex gap-3" href="https://mail.google.com/mail/?view=cm&fs=1&to=saadqureshi479@gmail.com&su=Contact via email" target="_blank" rel="noopener noreferrer">
                      <Mail className="text-white/50 mt-4.5 stroke-1 size-5" />
                      <div>
                        <h2 className="text-white/90 text-[13px] mt-3 tracking-tighter">saadqureshi479@gmail.com</h2>
                        <p className="text-gray-400/50 text-[9px] tracking-tight">Quick queries & questions</p>
                      </div>
                    </a>
            ...
            <div className="w-full lg:w-90 min-h-[27rem] bg-neutral-800/10 border border-white/10 rounded-lg p-4 sm:p-0">
              ...
              <form ref={formRef} onSubmit={sendEmail} className="mt-4 sm:ml-7 flex flex-col gap-4 pr-2">
                ...
                <button type="submit" disabled={loading} className="w-full lg:w-75 h-12 mt-1 flex items-center justify-center gap-2 rounded-sm border border-white/30 text-white/50 hover:bg-white/80 hover:text-black transition-all duration-300 disabled:opacity-50">
